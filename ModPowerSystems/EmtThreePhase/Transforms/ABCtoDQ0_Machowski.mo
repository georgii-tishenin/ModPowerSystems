...
model ABCtoDQ0_Machowski
  Modelica.Blocks.Interfaces.RealOutput V_dq[2] annotation (
...
equation
  V_dq =Transforms.Functions.ABCtoDQ_Machowski(V_abc,theta);
annotation (
